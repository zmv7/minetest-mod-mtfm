...
[![ContentDB](https://content.luanti.org/packages/Zemtzov7/lc/shields/downloads/)](https://content.minetest.net/packages/Zemtzov7/lc/)
### Usage
* Chatcommand `/lc [path]` - open file manager, optionally path(absolute) can be specified
...
* Read-only mode can be enabled in settings or in minetest.conf: `lc.read_only = true`
